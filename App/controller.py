...
def searchPaths(analyzer, initialStation, searchMethod):
    ...
    """
    # TO DO Lab 11, conectar con la funcion del model searchPaths
...
def hasSearchPath(analyzer, destStation, searchMethod):
    ...
    """
    # TO DO Lab 11, conectar con la funcion del model hasSearchPath
...
def searchPathTo(analyzer, destStation, searchMethod):
    ...
    """
    # TO DO Lab 11, conectar con la funcion del model searchPath
